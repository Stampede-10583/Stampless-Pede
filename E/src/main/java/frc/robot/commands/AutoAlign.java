...
public class AutoAlign extends Command {
    ...
    public void execute() {
        ...
        m_swerve.driveFieldOriented(m_swerve.getTargetSpeeds(m_controller.getLeftY()*-1*DriveConstants.kAutoAimScale,
                    m_controller.getLeftX()*-1 * DriveConstants.kAutoAimScale,
                    targetRot));
    }
