...
public class RobotContainer {
        ...
        public void configureBindings() {
                ...
                // m_DriverController.povDown().whileTrue(m_shooter.runShooterCommand(6000,
                // 2500));
                // m_DriverController.povUp().whileTrue(m_shooter.runShooterCommand(6000,
                // 2550));
                // m_DriverController.povLeft().whileTrue(m_shooter.runShooterCommand(6000,
                // 2650));
                // m_DriverController.povRight().whileTrue(m_shooter.runShooterCommand(6000,
                // 2750));
